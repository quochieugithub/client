                  ...
                  <div className="card-body">
                    <form className="form-horizontal" onSubmit={(event) => this.handleSubmit(event)}>
                      <div className="form-group row">
                        ...
                        <label className="col-sm-3 form-control-label" style={{textAlign: 'center'}}>Đại chỉ</label>
                        <div className="col-sm-3">
                      ...
                      <div className="form-group row">
                        ...
                        <label className="col-sm-3 form-control-label" style={{textAlign: 'center'}}>Xác thực Email <br /></label>
                        <div className="col-sm-3">
                          <div className="i-checks">
                            <input type="checkbox"
                              name="isVerifyEmail"
