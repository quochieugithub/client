...
class Discount extends Component {
  ...
  handleRemove = (id) => {
    MySwal.fire({
      ...
      text: "Nếu bạn xoá thì không thể quay lại",
      icon: 'warning',
              ...
              <div className="col-lg-12">
                <div className="card">
                  <div className="card-header d-flex align-items-center">
                    <h3 className="h4">Dữ liệu bảng sản phẩm giảm giá</h3>
                  ...
                  <form className="form-inline md-form form-sm mt-0" style={{ justifyContent: 'flex-end', paddingTop: 5, paddingRight: 20 }}>
                    ...
                    <Link to="/discounts/add" className="btn btn-primary" > Thêm mới</Link>
                  </form>
                      ...
                      <table className="table table-hover">
                        <thead>
                          <tr>
                            ...
                            <th>Tên sản phẩm</th>
                            <th>Mã</th>
                            <th>Tổng số cần tiếp cận</th>
                            <th>Đánh giá</th>
                            <th>Số lượng</th>
                            <th>Số lượng sử mã tối đa</th>
                            <th>Được sử dụng</th>
