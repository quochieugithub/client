      ...
      <div className="content-inner">
        ...
        <header className="page-header">
          <div className="container-fluid">
            <h2 className="no-margin-bottom">Form thêm sản phẩm</h2>
          </div>
        </header>
        {/* Breadcrumb*/}
                  ...
                  <div className="card-body">
                    <form className="form-horizontal" onSubmit={(event) => this.handleSubmit(event)} >
                      ...
                      <div className="form-group row">
                        ...
                        <label className="col-sm-3 form-control-label" style={{textAlign: 'center'}}>Có sẵn hàng</label>
                        <div className="col-sm-3">
                      ...
                      <div className="line" />
                      <div className="form-group row">
                        <label className="col-sm-3 form-control-label">Miêu tả</label>
                        <div className="col-sm-9">
                          <ReactQuill
                      ...
                      <div className="line" />
                      <div className="form-group row">
                        <label className="col-sm-3 form-control-label">Trạng thái <br /></label>
                        <div className="col-sm-9">
                      ...
                      <div className="line" />
                      <div className="form-group row">
                        <label className="col-sm-3 form-control-label">Người sản xuất</label>
                        <div className="col-sm-9">
                      ...
                      <div className="line" />
                      <div className="form-group row">
                        <label className="col-sm-3 form-control-label pt-50">Phòng trưng bày</label>
                        <div className="col-sm-9">
