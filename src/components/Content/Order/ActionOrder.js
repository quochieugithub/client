...
class ActionOrder extends Component {
  ...
  sumTotal = (itemAmount, shippingTotal, promoTotal) => {
    ...
    if (result < 0) {
      return toast.error('Lỗi! Tổng tiền không thể < 0');
    }
    return result;
  }
      ...
      <div className="content-inner">
        ...
        <header className="page-header">
          <div className="container-fluid">
            <h2 className="no-margin-bottom">Form Đặt Hàng</h2>
          </div>
        </header>
        {/* Breadcrumb*/}
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    <form className="form-horizontal" onSubmit={(event) => this.handleSubmit(event)} >
                      ...
                      <div className="line" />
                      <div className="form-group row">
                        <label className="col-sm-3 form-control-label">Tỉnh</label>
                        ...
                        <label className="col-sm-3 form-control-label" style={{textAlign: 'center'}}>Quận</label>
                        <div className="col-sm-3">
                          <select
                      ...
                      <div className="line" />
                      <div className="form-group row">
                        <label className="col-sm-3 form-control-label">Địa chỉ nhà</label>
                        <div className="col-sm-3">
                      ...
                      <div className="line" />
                      {
                       ...
                       <div className="line" />
                      <div className="form-group row">
                        <label className="col-sm-3 form-control-label" style={{paddingTop: 50}}>Mặt hàng</label>
                        <div className="col-sm-9">
                        <div className="card-body">
                    <div className="table-responsive">
                      <table className="table table-hover">
                        ...
                        <td><b style={{fontSize: 16}}>${orderDetailAmount}</b></td>
                          ...
                          <div className="form-group row">
                            ...
                            <label className="col-sm-3 form-control-label" style={{textAlign: 'center'}} >Mã Paypal</label>
                            <div className="col-sm-3">
                          ...
                          <div className="line" />
                          <div className="form-group row">
                            <label className="col-sm-3 form-control-label">Số lượng mặt hàng</label>
                            <div className="col-sm-3">
                              <input name="itemAmount" disabled value={itemAmount} onChange={this.handleChange} type="number" className="form-control" />
                            </div>
                            <label className="col-sm-3 form-control-label" style={{textAlign: 'center'}}>Tổng tiền vận chuyển</label>
                            <div className="col-sm-3">
                          ...
                          <div className="line" />
                          <div className="form-group row">
                            <label className="col-sm-3 form-control-label">Tổng khuyến mãi</label>
                            <div className="col-sm-3">
                              <input name="shippingTotal" disabled value={promoTotal} onChange={this.handleChange} type="number" className="form-control" />
                            </div>
                            <label className="col-sm-3 form-control-label" style={{textAlign: 'center'}}>Tổng thanh toán</label>
                            <div className="col-sm-3">
                          ...
                          <div className="line" />
                          <div className="form-group row">
                            <label className="col-sm-3 form-control-label">Tổng tiền khuyến mãi</label>
                            <div className="col-sm-3">
                      ...
                      <div className="form-group row">
                        ...
                        <label className="col-sm-3 form-control-label" style={{textAlign: 'center'}}>Thanh toán trực tuyến</label>
                        <div className="col-sm-3">
                          <div className="i-checks">
                            <input type="checkbox"
                              onChange={this.handleChange}
