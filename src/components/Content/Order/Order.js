...
class Order extends Component {
  ...
  handleRemove = (id) => {
    MySwal.fire({
      ...
      text: "Bạn không thể quay lại khi đã xoá",
      icon: 'warning',
              ...
              <div className="col-lg-12">
                <div className="card">
                  <div className="card-header d-flex align-items-center">
                    <h3 className="h4">Dữ liệu bảng đặt hàng</h3>
                  ...
                  <form
                    ...
                    <Link to="/orders/add" className="btn btn-primary" > Tạo mới</Link>
                  </form>
                      ...
                      <table className="table table-hover">
                        <thead>
                          <tr>
                            ...
                            <th>Trạng thái</th>
                            <th>Đã thanh toán</th>
                            <th style={{ textAlign: "center" }}>Thanh toán online</th>
