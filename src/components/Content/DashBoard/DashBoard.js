      ...
      <div className="content-inner">
        ...
        <section className="dashboard-counts no-padding-bottom">
          <div className="container-fluid">
            <div className="row bg-white has-shadow">
              ...
              <div className="col-xl-3 col-sm-6">
                <div className="item d-flex align-items-center">
                  ...
                  <div className="title"><span>Người dùng<br />mới</span>
              ...
              <div className="col-xl-3 col-sm-6">
                <div className="item d-flex align-items-center">
                  ...
                  <div className="title"><span>Đơn hàng</span>
                    <div className="progress">
              ...
              <div className="col-xl-3 col-sm-6">
                <div className="item d-flex align-items-center">
                  ...
                  <div className="title"><span>Sản phẩm<br />mới</span>
                    <div className="progress">
              ...
              <div className="col-xl-3 col-sm-6">
                <div className="item d-flex align-items-center">
                  ...
                  <div className="title"><span>Tổng<br />thu nhập</span>
                    <div className="progress">
            ...
            <h3 style={{paddingTop: 20}}>Báo cáo sản phẩm và danh mục</h3>
            <Pie 
              width={100}
              height={25} data={dataPie} />
            <br />
            <br />
            <h3>Báo cáo tổng thu nhập</h3>
            <HorizontalBar 
            width={100}
            height={30} data={dataHozi} />
             <br />
             <br />
             <h3>Báo cáo liên hệ</h3>
             <Line  width={100}
            height={15}
              data={dataLine} />
          </div>
