                        ...
                        <div className="li-review-content">
                          ...
                          <div className="feedback-area">
                            <div className="feedback">
                              <h3 className="feedback-title">Đánh giá của chúng tôi</h3>
                              <form action="/">
            ...
            <div className="col-lg-7 col-md-6">
              <div className="product-details-view-content sp-normal-content pt-60">
                <div className="product-info">
                  ...
                  <div className="rating-box pt-20">
                    <ul className="rating rating-with-review-item">
                      ...
                      <button className="fix-btn-review btn" onClick={this.openModal}>
                        <li className="review-item">Đánh giá </li>
                      </button>
                    </ul>
                    <li>
                      <Link to="#">{count} xếp hạng</Link>
                    </li>
                  </div>
                  ...
                  <span>
                    (Chúng tôi có {product.numberAvailable ? product.numberAvailable : 0} sản phẩm
                    có sẵn)
                  </span>
