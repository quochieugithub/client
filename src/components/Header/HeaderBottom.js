                  ...
                  <div className="collapse navbar-collapse" id="collapsibleNavId">
                    <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
                      ...
                      <li className="nav-item dropdown">
                        <Link className="nav-link dropdown-toggle" to="#" id="dropdownId" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">LOẠI</Link>
                      ...
                      <li className="nav-item">
                        <Link onClick={() => this.loaddingPage()} className="nav-link" to="/about">GIỚI THIỆU</Link>
                      </li>
                      <li className="nav-item">
