          ...
          <div className="product_desc">
            ...
            <div className="add-actions">
              <ul className="add-actions-link">
                ...
                {/* <li><Link onClick={(id) => this.getInfoProduct(product.id)} to={`/products/${product.id}`} title="xem" className="quick-view-btn" data-toggle="modal" data-target="#exampleModalCenter7"><i className="fa fa-eye" /></Link></li> */}
